...
export interface ISessionGitContext {
	readonly cwd?: string;
...
export async function projectFromSessionContext(context: ISessionGitContext | undefined, gitService: IAgentHostGitService): Promise<IAgentSessionProjectInfo | undefined> {
