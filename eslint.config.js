...
export default defineConfig(
	...
	},
	{
		...
		// The Agents window (sessions workbench) must stay provider-agnostic.
				...
				'warn',
				{
					'patterns': [
						...
						},
						{
							...
							'message': 'IAgentSessionsService is provider-internal. The Agents window must stay provider-agnostic. See src/vs/sessions/SESSIONS.md.'
						}
					]
				}
			]
